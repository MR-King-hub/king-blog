...
INSERT INTO "new_pending_tasks" ("createdAt", "deliveredVia", "finalReply", "id", "imMessageId", "ownerReply", "proposal", "resolvedAt", "sessionId", "status", "type", "visitorEmail", "visitorRequest") SELECT "createdAt", "deliveredVia", "finalReply", "id", "imMessageId", "ownerReply", "proposal", "resolvedAt", "sessionId", "status", "type", "visitorEmail", "visitorRequest" FROM "pending_tasks";
